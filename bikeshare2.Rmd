---
title: "Los Angeles Metro Bike Share Analysis & Predictive Model"
author: "Daniel Romotsky"
date: "11/30/2019"
output: word_document
<!-- author: <span style="color:green">Daniel Romotsky</span> -->
---
![](/Users/danielromotsky/Documents/bike_files/title3.gif)
...
```{r setup, include=TRUE, echo=FALSE, message=FALSE, fig.retina = 1}
knitr::opts_chunk$set(fig.width=12, fig.height=8,
                      echo = FALSE, message=FALSE,  warning=FALSE)
knitr::opts_knit$set(root.dir = "/Users/danielromotsky/Documents/bike_files")
...
```{r map2, echo=FALSE, eval=TRUE, fig.retina = 1}
library(ggmap)
register_google(key = "INSERT KEY HERE!!!") ## input your google api key
```
...
```{r getthedata, echo = FALSE, fig.retina = 1}
...
```
```{r continuepull, echo=FALSE, results='hide', fig.retina = 1}
...
```
```{r newvars, results='hide', fig.retina = 1}
library(lubridate)
...
```{r stationlookup, results='hide', fig.retina = 1}
station_index <- str_detect(html_text(nodes), "Station Table")
html_text(nodes)[station_index]
html_attr(nodes, "href")[station_index]
station_url <- html_attr(nodes, "href")[station_index]
...
```{r cleansing, results='hide', fig.retina = 1}
...
```{r viz, warnings=FALSE, fig.retina = 1}
# library(dplyr)
#daily trend
...
```{r remove, results='hide', fig.retina = 1}
...
```{r neighborhoodviews, results='hide', fig.retina = 1}
...
```{r datamodel, results='hide', fig.retina = 1}
...
```{r showdataset, results='hide', fig.retina = 1}
...
RMSE(test$n, predict_variable) ## will give us the prediced error
```


### Station Average
```{r station_avg, fig.retina = 1}
...
```{r wday2, eval=FALSE, fig.retina = 1}
...
```{r stationmodel, eval=FALSE, results='hide', fig.retina = 1}
...
```{r ciclavia, results='hide', fig.retina = 1}
...
```{r ghdhfid, results='hide', fig.retina = 1}
...
```{r regnewtry, echo=TRUE, fig.retina = 1}
lambdas <- seq(0, 10, .10)
...
```{r trendddd4, results='hide', fig.retina = 1}
...
```{r fhidfh2, results='hide', fig.retina = 1}
...
```{r final, eval=TRUE, fig.retina = 1}
## final view
...
```{r poroepr, eval=FALSE, results="hide", fig.retina = 1}
m <- map2 %>% ggmap()
m + geom_point(data = (
